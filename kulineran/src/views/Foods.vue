      ...
      <div class="row mt-3">
        <div class="col">
            <div class="input-group mb-3">
                <input v-model="search" type="text" class="form-control" placeholder="Cari Makanan Sesuai Selera" aria-label="Cari" aria-describedby="basic-addon1" @keyup="searchFood">
